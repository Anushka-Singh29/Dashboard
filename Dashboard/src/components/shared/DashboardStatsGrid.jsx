        ...
        <div className='flex gap-4 w-full '>
            <BoxWrapper>
                ...
                <div className='pl-4'>
                    ...
                    <div className='flex items-center'>
                        <strong className='text-xl text-gray-700 font-semibold'>$34562.68</strong>
            ...
            <BoxWrapper>
                ...
                <div className='pl-4'>
                    ...
                    <div className='flex items-center'>
                        <strong className='text-xl text-gray-700 font-semibold'>$3434.68</strong>
            ...
            <BoxWrapper>
                ...
                <div className='pl-4'>
                    ...
                    <div className='flex items-center'>
                        <strong className='text-xl text-gray-700 font-semibold'>10009</strong>
